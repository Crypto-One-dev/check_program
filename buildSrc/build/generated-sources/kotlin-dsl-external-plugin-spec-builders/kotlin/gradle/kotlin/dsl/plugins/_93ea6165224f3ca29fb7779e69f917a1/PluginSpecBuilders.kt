...
package gradle.kotlin.dsl.plugins._93ea6165224f3ca29fb7779e69f917a1
...
/**
 * The `com.diffplug.configuration-cache-for-platform-specific-build` plugin implemented by [com.diffplug.gradle.swt.PlatformSpecificBuildPlugin].
 */
internal
val `ComDiffplugPluginGroup`.`configuration-cache-for-platform-specific-build`: PluginDependencySpec
    get() = plugins.id("com.diffplug.configuration-cache-for-platform-specific-build")


/**
 * The `com.diffplug.eclipse` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugEclipsePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.eclipse`.
 */
internal
val `ComDiffplugPluginGroup`.`eclipse`: `ComDiffplugEclipsePluginGroup`
    get() = `ComDiffplugEclipsePluginGroup`(plugins)


/**
 * The `com.diffplug.eclipse.apt` plugin implemented by [com.diffplug.gradle.eclipse.apt.AptEclipsePlugin].
 */
internal
val `ComDiffplugEclipsePluginGroup`.`apt`: PluginDependencySpec
    get() = plugins.id("com.diffplug.eclipse.apt")


/**
 * The `com.diffplug.eclipse.buildproperties` plugin implemented by [com.diffplug.gradle.eclipse.BuildPropertiesPlugin].
 */
internal
val `ComDiffplugEclipsePluginGroup`.`buildproperties`: PluginDependencySpec
    get() = plugins.id("com.diffplug.eclipse.buildproperties")


/**
 * The `com.diffplug.eclipse.excludebuildfolder` plugin implemented by [com.diffplug.gradle.eclipse.ExcludeBuildFolderPlugin].
 */
internal
val `ComDiffplugEclipsePluginGroup`.`excludebuildfolder`: PluginDependencySpec
    get() = plugins.id("com.diffplug.eclipse.excludebuildfolder")


/**
 * The `com.diffplug.eclipse.mavencentral` plugin implemented by [com.diffplug.gradle.eclipse.MavenCentralPlugin].
 */
internal
val `ComDiffplugEclipsePluginGroup`.`mavencentral`: PluginDependencySpec
    get() = plugins.id("com.diffplug.eclipse.mavencentral")


/**
 * The `com.diffplug.eclipse.projectdeps` plugin implemented by [com.diffplug.gradle.eclipse.ProjectDepsPlugin].
 */
internal
val `ComDiffplugEclipsePluginGroup`.`projectdeps`: PluginDependencySpec
    get() = plugins.id("com.diffplug.eclipse.projectdeps")


/**
 * The `com.diffplug.eclipse.resourcefilters` plugin implemented by [com.diffplug.gradle.eclipse.ResourceFiltersPlugin].
 */
internal
val `ComDiffplugEclipsePluginGroup`.`resourcefilters`: PluginDependencySpec
    get() = plugins.id("com.diffplug.eclipse.resourcefilters")
...
/**
 * The `com.diffplug.gradle.eclipse` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugGradleEclipsePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.gradle.eclipse`.
 */
internal
val `ComDiffplugGradlePluginGroup`.`eclipse`: `ComDiffplugGradleEclipsePluginGroup`
    get() = `ComDiffplugGradleEclipsePluginGroup`(plugins)


/**
 * The `com.diffplug.gradle.eclipse.buildproperties` plugin implemented by [com.diffplug.gradle.eclipse.BuildPropertiesPlugin.Legacy].
 */
internal
val `ComDiffplugGradleEclipsePluginGroup`.`buildproperties`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.eclipse.buildproperties")


/**
 * The `com.diffplug.gradle.eclipse.excludebuildfolder` plugin implemented by [com.diffplug.gradle.eclipse.ExcludeBuildFolderPlugin.Legacy].
 */
internal
val `ComDiffplugGradleEclipsePluginGroup`.`excludebuildfolder`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.eclipse.excludebuildfolder")


/**
 * The `com.diffplug.gradle.eclipse.mavencentral` plugin implemented by [com.diffplug.gradle.eclipse.MavenCentralPlugin.Legacy].
 */
internal
val `ComDiffplugGradleEclipsePluginGroup`.`mavencentral`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.eclipse.mavencentral")


/**
 * The `com.diffplug.gradle.eclipse.projectdeps` plugin implemented by [com.diffplug.gradle.eclipse.ProjectDepsPlugin.Legacy].
 */
internal
val `ComDiffplugGradleEclipsePluginGroup`.`projectdeps`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.eclipse.projectdeps")


/**
 * The `com.diffplug.gradle.eclipse.resourcefilters` plugin implemented by [com.diffplug.gradle.eclipse.ResourceFiltersPlugin.Legacy].
 */
internal
val `ComDiffplugGradleEclipsePluginGroup`.`resourcefilters`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.eclipse.resourcefilters")


/**
 * The `com.diffplug.gradle.equinoxlaunch` plugin implemented by [com.diffplug.gradle.eclipserunner.EquinoxLaunchPlugin.Legacy].
 */
internal
val `ComDiffplugGradlePluginGroup`.`equinoxlaunch`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.equinoxlaunch")


/**
 * The `com.diffplug.gradle.oomph` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugGradleOomphPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.gradle.oomph`.
 */
internal
val `ComDiffplugGradlePluginGroup`.`oomph`: `ComDiffplugGradleOomphPluginGroup`
    get() = `ComDiffplugGradleOomphPluginGroup`(plugins)


/**
 * The `com.diffplug.gradle.oomph.ide` plugin implemented by [com.diffplug.gradle.oomph.OomphIdePlugin.Legacy].
 */
internal
val `ComDiffplugGradleOomphPluginGroup`.`ide`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.oomph.ide")


/**
 * The `com.diffplug.gradle.osgi` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugGradleOsgiPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.gradle.osgi`.
 */
internal
val `ComDiffplugGradlePluginGroup`.`osgi`: `ComDiffplugGradleOsgiPluginGroup`
    get() = `ComDiffplugGradleOsgiPluginGroup`(plugins)


/**
 * The `com.diffplug.gradle.osgi.bndmanifest` plugin implemented by [com.diffplug.gradle.osgi.BndManifestPlugin.Legacy].
 */
internal
val `ComDiffplugGradleOsgiPluginGroup`.`bndmanifest`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.osgi.bndmanifest")


/**
 * The `com.diffplug.gradle.p2` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugGradleP2PluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.gradle.p2`.
 */
internal
val `ComDiffplugGradlePluginGroup`.`p2`: `ComDiffplugGradleP2PluginGroup`
    get() = `ComDiffplugGradleP2PluginGroup`(plugins)


/**
 * The `com.diffplug.gradle.p2.asmaven` plugin implemented by [com.diffplug.gradle.p2.AsMavenPlugin.Legacy].
 */
internal
val `ComDiffplugGradleP2PluginGroup`.`asmaven`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.p2.asmaven")
...
/**
 * The `com.diffplug.gradle.swt` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugGradleSwtPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.gradle.swt`.
 */
internal
val `ComDiffplugGradlePluginGroup`.`swt`: `ComDiffplugGradleSwtPluginGroup`
    get() = `ComDiffplugGradleSwtPluginGroup`(plugins)


/**
 * The `com.diffplug.gradle.swt.nativedeps` plugin implemented by [com.diffplug.gradle.swt.NativeDepsPlugin.Legacy].
 */
internal
val `ComDiffplugGradleSwtPluginGroup`.`nativedeps`: PluginDependencySpec
    get() = plugins.id("com.diffplug.gradle.swt.nativedeps")


/**
 * The `com.diffplug.oomph` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugOomphPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.oomph`.
 */
internal
val `ComDiffplugPluginGroup`.`oomph`: `ComDiffplugOomphPluginGroup`
    get() = `ComDiffplugOomphPluginGroup`(plugins)


/**
 * The `com.diffplug.oomph.ide` plugin implemented by [com.diffplug.gradle.oomph.OomphIdePlugin].
 */
internal
val `ComDiffplugOomphPluginGroup`.`ide`: PluginDependencySpec
    get() = plugins.id("com.diffplug.oomph.ide")


/**
 * The `com.diffplug.osgi` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugOsgiPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.osgi`.
 */
internal
val `ComDiffplugPluginGroup`.`osgi`: `ComDiffplugOsgiPluginGroup`
    get() = `ComDiffplugOsgiPluginGroup`(plugins)


/**
 * The `com.diffplug.osgi.bndmanifest` plugin implemented by [com.diffplug.gradle.osgi.BndManifestPlugin].
 */
internal
val `ComDiffplugOsgiPluginGroup`.`bndmanifest`: PluginDependencySpec
    get() = plugins.id("com.diffplug.osgi.bndmanifest")


/**
 * The `com.diffplug.osgi.equinoxlaunch` plugin implemented by [com.diffplug.gradle.eclipserunner.EquinoxLaunchPlugin].
 */
internal
val `ComDiffplugOsgiPluginGroup`.`equinoxlaunch`: PluginDependencySpec
    get() = plugins.id("com.diffplug.osgi.equinoxlaunch")


/**
 * The `com.diffplug.p2` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugP2PluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.p2`.
 */
internal
val `ComDiffplugPluginGroup`.`p2`: `ComDiffplugP2PluginGroup`
    get() = `ComDiffplugP2PluginGroup`(plugins)


/**
 * The `com.diffplug.p2.asmaven` plugin implemented by [com.diffplug.gradle.p2.AsMavenPlugin].
 */
internal
val `ComDiffplugP2PluginGroup`.`asmaven`: PluginDependencySpec
    get() = plugins.id("com.diffplug.p2.asmaven")
...
/**
 * The `com.diffplug.swt` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDiffplugSwtPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.diffplug.swt`.
 */
internal
val `ComDiffplugPluginGroup`.`swt`: `ComDiffplugSwtPluginGroup`
    get() = `ComDiffplugSwtPluginGroup`(plugins)


/**
 * The `com.diffplug.swt.nativedeps` plugin implemented by [com.diffplug.gradle.swt.NativeDepsPlugin].
 */
internal
val `ComDiffplugSwtPluginGroup`.`nativedeps`: PluginDependencySpec
    get() = plugins.id("com.diffplug.swt.nativedeps")
